...
import static com.admin.lifegame.MainMenu.width1;
...
public class Rangs_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  text18.setTextSize(MainMenu.width1/40);
       ...
       //rang15.setTextSize(MainMenu.width1/40);
        rang15.setX(0);
       ...
       // rang16.setTextSize(MainMenu.width1/40);
        rang16.setX(0);
       ...
       // rang17.setTextSize(MainMenu.width1/40);
        rang17.setX(0);
       ...
       // rang18.setTextSize(MainMenu.width1/40);
        rang18.setX(0);
        ...
        //rang19.setTextSize(MainMenu.width1/40);
        rang19.setX(0);
       ...
       // rang20.setTextSize(MainMenu.width1/40);
        rang20.setX(0);
       ...
       // rang21.setTextSize(MainMenu.width1/40);
        rang21.setX(0);
        ...
        //rang22.setTextSize(MainMenu.width1/40);
        rang22.setX(0);
        ...
        //rang23.setTextSize(MainMenu.width1/40);
        rang23.setX(0);
